...
```bash
bun add @donotdev/cli
# or
npm install @donotdev/cli
```
...
- [Report a bug](https://github.com/donotdev/cli/issues/new?template=bug_report.md)
- [Request a feature](https://github.com/donotdev/cli/issues/new?template=feature_request.md)
